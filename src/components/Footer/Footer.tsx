                    ...
                    <div className={styles["social-icons"]}>
                        <a href="#" aria-label="LinkedIn">
                            <svg
                                ...
                                role="img"
                            >
                                <path d="M21.8,0H2.2C1,0,0,1,0,2.2v19.6C0,23,1,24,2.2,24h19.6c1.2,0,2.2-1,2.2-2.2V2.2C24,1,23,0,21.8,0z M7.4,20.7H3.9V9.4h3.5V20.7z M5.6,7.9c-1.2,0-2.2-1-2.2-2.2s1-2.2,2.2-2.2s2.2,1,2.2,2.2S6.9,7.9,5.6,7.9z M20.7,20.7h-3.5v-5.6c0-1.3-0-3-1.8-3s-2.1,1.4-2.1,2.9v5.7H9.8V9.4h3.4v1.5h0.1c0.5-0.9,1.6-1.8,3.3-1.8c3.5,0,4.2,2.3,4.2,5.3V20.7z" />
                            </svg>
                        </a>
